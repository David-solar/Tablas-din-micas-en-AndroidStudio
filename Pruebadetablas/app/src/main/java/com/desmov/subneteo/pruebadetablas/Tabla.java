package com.desmov.subneteo.pruebadetablas;
...
public class Tabla
{
    ...
    public void agregarCabecera(int recursocabecera)
    {
        ...
        TableRow.LayoutParams layoutFila = new TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT, TableRow.LayoutParams.MATCH_PARENT);
        ...
        for(int i = 0; i < arraycabecera.length; i++)
        {
            ...
            texto.setTextAppearance(actividad, R.style.estilo_celda);//"#0C0B33" 12,11,51
            //texto.setTextColor(Color.parseColor("#000054"));
